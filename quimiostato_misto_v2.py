...
def update_max_values(args):
    (miu_gluc,miu_xil,miu_mist,MIU_mist_max,qp_gluc,QP_gluc_max,qp_xil,QP_xil_max,qp_mist,QP_mist_max,F,P_out,Pout_max,S2_xil,S2_gluc,X2, X_max,P2) = args
    ...
    return (miu_gluc_max,miu_xil_max,miu_mist_max,MIU_mist_max,qp_gluc_max,QP_gluc_max,qp_xil_max,QP_xil_max,qp_mist_max,QP_mist_max,F_max,P_out_max,Pout_max,S2_xil_max,S2_gluc_max,X2_max,X_max,P2_max)
...
def main():
        ...
        for S2_xil in S_xil: # S2_xil varia na gama de valores definida
            for S2_gluc in S_gluc: # S2_gluc varia na gama de valores definida
                ...
                if P_out > P_out_max: # quando a saída de produto é superior à máxima já encontrada
                    args = (miu_gluc,miu_xil,miu_mist,MIU_mist_max,qp_gluc,QP_gluc_max,qp_xil,QP_xil_max,qp_mist,QP_mist_max,F,P_out,Pout_max,S2_xil,S2_gluc,X2, X_max,P2)
    ...
    args_to_show = (V,qs_gluc_max,qs_xil_max,S1_gluc_max,S1_xil_max,x2,Pout,x,QP_gluc,QP_xil,QP_mist,MIU_mist,X)
    results(out_max, args_to_show)
