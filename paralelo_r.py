...
Fw_gluc_max,Xw_gluc_max,Fs_gluc_max,Fr_gluc_max,X2_gluc_max,P_out_gluc_max,S2_gluc_max,P2_gluc_max,qp_gluc_max,\
                            miu_gluc_max, qs_gluc_max,divergente_gluc = calculo_de_valores_maximos(
...
Fw_xil_max,Xw_xil_max,Fs_xil_max,Fr_xil_max,X2_xil_max,P_out_xil_max,S2_xil_max,P2_xil_max,qp_xil_max,\
                            miu_xil_max, qs_xil_max,divergente_xil = calculo_de_valores_maximos(
                            Fw_xil_r,Fr_xil_r,F_xil,V,Y_XS_xil,ms_xil,S2_xil_e,S1_xil,P2_xil_e,qp_xil_e,
                            X2_xil_e,Xw_xil_e,mium_xil,Kis_xil,Ks_xil,b_xil,g_xil,Kp_xil,Kip_xil,Pm_sub_xil,Pm_prod_xil,qpm_xil)
